import './BusinessNotificationCenter.css';
...
const business_id = 1; // This is a hard-coded business_id. Once authentication is set-up, change the hard-coded business_id to be the business business_id.
...
const BusinessNotificationCenter = () => {
  ...
  const getData = async () => {
    try {
      const response = await backend.get(`/notification/${business_id}`);
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Text>
              ...
              iusto quibusdam, saepe fugit. Voluptatibus tempore porro qubusiness_idem laboriosam repellendus
