...
import { Flex, Text, Textarea, Stack, Box, Spacer, Button, Input, InputGroup, InputLeftElement, Icon } from '@chakra-ui/react';
import { PhoneIcon } from '@chakra-ui/icons';


const EditContactInformation = () => { // how will id be passed in?
            ...
            <Stack>
                <Box>
                    ...
                    <InputGroup>
                      ...
                      <Input placeholder={name ? name : 'Enter Full Name'} onChange={(e) =>setName(e.target.value)}></Input>
                    </InputGroup>
                    {/* <InputGroup>
                    ...
                    <InputGroup>
                      ...
                      <Input placeholder={phoneNumber ? phoneNumber : '(xxx) xxx-xxxx'} onChange={(e) => setPhoneNumber(e.target.value)}></Input>
                    </InputGroup>
                    <Text>Email</Text>
                    <InputGroup>
                      <InputLeftElement>
                     ...
                     <Input placeholder={email ? email : 'example@email.com'} onChange={(e) => setEmail(e.target.value)}></Input>
                    </InputGroup>
                    ...
                    <InputGroup>
                      ...
                      <Input placeholder={website ? website : 'example.com'} onChange={(e) => setWebsite(e.target.value)}></Input>
                    </InputGroup>
                    <Text>Address</Text>
                    <InputGroup>
                      <InputLeftElement>
                      ...
                      <Input placeholder={address ? address : '123 Address Lane'} onChange={(e) => setAddress(e.target.value)}></Input>
                    </InputGroup>
